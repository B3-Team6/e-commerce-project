  ...
  return (
    ...
    <div className="h-full">
      ...
      <div className="flex flex-col gap-8 ml-3">
        <div>
          <h3 className="font-medium text-lg">AGREEMENT TO OUR LEGAL TERMS</h3>
          <p>We are Airnes ("Company," "we," "us," "our").</p>
          <p>
            We operate the website http://www.airnes.com (the "Site"), as well
          ...
          <p>
            ...
            and Airnes, concerning your access to and use of the Services. You
        ...
        <div>
          <h3 className="font-medium text-lg">1. OUR SERVICES</h3>
          <p>
        ...
        <div>
          ...
          <h4 className="font-medium text-lg">Our intellectual property</h4>
          <p>
          ...
          <h4 className="font-medium text-lg">Your use of our Services</h4>
          <p>
          ...
          <h4 className="font-medium text-lg">Your submissions</h4>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">4. USER REGISTRATION</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">5. PRODUCTS</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">6. PURCHASES AND PAYMENT</h3>
        ...
        <div>
          <h3 className="font-medium text-lg">7. RETURN POLICY</h3>
          <p>All sales are final and no refund will be issued.</p>
        </div>
        <div>
          <h3 className="font-medium text-lg">8. CONTRIBUTION LICENSE</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">9. GUIDELINES FOR REVIEWS</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">10. SOCIAL MEDIA</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">12. SERVICES MANAGEMENT</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">13. PRIVACY POLICY</h3>
          <p>
            We care about data privacy and security. Please review our Privacy
            Policy: http://www.airnes.com/privacy. By using the Services, you
            ...
            France. If you access the Services from any other region of the
            ...
            France, then through your continued use of the Services, you are
            transferring your data to France, and you expressly consent to have
            your data transferred to and processed in France. Further, we do not
        ...
        <div>
          <h3 className="font-medium text-lg">14. TERM AND TERMINATION</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">16. GOVERNING LAW</h3>
          <p>
            ...
            provisions of the law in your country to residence. Airnes and
        ...
        <div>
          <h3 className="font-medium text-lg">17. DISPUTE RESOLUTION</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">18. CORRECTIONS</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">19. DISCLAIMER</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">20. LIMITATIONS OF LIABILITY</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">21. INDEMNIFICATION</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">22. USER DATA</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">25. MISCELLANEOUS</h3>
          <p>
        ...
        <div>
          <h3 className="font-medium text-lg">26. CONTACT US</h3>
          <p>
            In order to resolve a complaint regarding the Services or to receive
            further information regarding use of the Services, please contact us
            using our website's contact page.
          </p>
        </div>
      </div>
      </div>
