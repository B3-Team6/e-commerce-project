...
const App = (props) => 
{
 const {onSubmit} = props
  ...
  return (
    <>
    <div className="flex justify-center text-xl font-bold sm:my-20 lg:text-5xl">Connexion</div>
      <Formik
      ...
      >
        {({ isSubmitting, isValid}) => (
          <Form className="flex flex-col gap-4 mx-6 lg:mx-12">
            ...
            <div className="flex items-center justify-center font-bold mb-80 lg:mb-32">
