...
const CarouselProduct = () => {
  ...
  return (
    <div className="relative w-2/4">
      <button
        className="absolute top-1/2 left-0 -translate-y-1/2 pr-3 pl-6 py-2 bg-white bg-opacity-50 hover:bg-opacity-75 rounded-md"
        onClick={previousImage}
      >
        <ArrowLeftIcon className="w-8 h-8 text-black" />
      </button>
      <button
        className="absolute top-1/2 right-0 -translate-y-1/2 pr-6 pl-3 py-2 bg-white bg-opacity-50 hover:bg-opacity-75 rounded-md"
        onClick={nextImage}
      >
